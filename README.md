...
This project also provides some 3D files for testing purposes under [ARoMA/Extra Files/Demo/3D Objects](https://github.com/IZMEHD/ARoMA/tree/main/Extra20Files/Demo/3D_20Objects).  
